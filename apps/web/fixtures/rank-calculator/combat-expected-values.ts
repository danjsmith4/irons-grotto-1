import { CombatPointCalculatorData } from '@/app/player/hooks/point-calculator/combat/use-combat-point-calculator';
...
export const combatExpectedValues = {
  earlyGamePlayer: {
    ...
    threeWeekScaling: {
      pointsAwarded: 438,
      pointsAwardedPercentage: 0.0499,
