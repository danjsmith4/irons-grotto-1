...
export function SkillingCard() {
  ...
  return (
    <DataCard.Root>
      ...
      <DataCard.Row
        left={
          <Text style={{ color: 'rgb(var(--ig-text-muted))' }} weight="medium" size="2">
            Category
          </Text>
        }
        right={
      ...
      <DataCard.Row
        left={
          <Text style={{ color: 'rgb(var(--ig-text-muted))' }} size="2">
            EHP
          </Text>
        }
        center={
      ...
      <DataCard.Row
        ...
        right={
          <Text
            aria-label="Skilling points remaining"
            style={{ color: 'rgb(var(--ig-text-muted))' }}
            size="2"
          >
