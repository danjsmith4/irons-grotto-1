  ...
  return (
    <DataCard.Root>
      ...
      <DataCard.Row
        ...
        right={
          <Text aria-label="TzHaar cape points" style={{color: '#b39ddb'}} size="2">
      ...
      <DataCard.Row
        ...
        right={
          <Text aria-label="Dizana's quiver points" style={{color: '#b39ddb'}} size="2">
      ...
      <DataCard.Row
        left={
          <ValidationTooltip error={errors.hasBloodTorva} style={{color: '#b39ddb'}} size="2">
            <Text>Blood torva</Text>
          </ValidationTooltip>
        }
        center={<Checkbox name="hasBloodTorva" checked={hasBloodTorva} />}
        right={
          <Text aria-label="Blood torva points" style={{color: '#b39ddb'}} size="2">
      ...
      <DataCard.Row
        ...
        right={
          <Text aria-label="Radiant oathplate points" style={{color: '#b39ddb'}} size="2">
      ...
      <DataCard.Row
        ...
        right={
          <Text aria-label="Combat points remaining" style={{color: '#b39ddb'}} size="2">
